...
const PHOTO_URLS = {
  ...
  '1304': './photos/noho-pose.jpg',
  '1308': './photos/noho.jpg',
  '1311': './photos/noho-pose.jpg',
  '1313': './photos/noho.jpg',
  '1314': './photos/noho-pose.jpg',
  '1315': './photos/noho.jpg',
  '1317': './photos/noho-pose.jpg',
  '1320': './photos/noho.jpg',
  '1322': './photos/noho-pose.jpg',
  // No distinct Central Park binary derivative survived the earlier prototype export.
  // Keep the marker structural rather than showing a wrong place photograph.
  '1323': null
};
...
function buildMarker(clusterId) {
  ...
  if (visible.length) {
    for (const obs of visible) {
      ...
      img.alt = '';
      img.decoding = 'async';
      img.src = `${PHOTO_URLS[String(obs.id)]}?v=25`;
...
function ensureMarkers() {
  ...
  // Photo cards replace the old MapLibre text labels. Keep the glow fields only.
